// =============================================================
// tests/daily-route/11_addToWishList.spec.js
// Test: Daily Route - Add To Wish List
// =============================================================
"use strict";
...
test.describe.serial("Daily Route - Add To Wish List", () => {
    ...
    test("Daily Route - Add To Wish List", async ({ mainWindow }) => {
        ...
        // await mainWindow.locator('span[data-translate="NEEDS"]').click();
